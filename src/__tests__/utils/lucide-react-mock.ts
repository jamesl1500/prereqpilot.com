...
export const FileQuestionMark = mockIcon;
export const LayoutDashboard = mockIcon;
export const PcCase = mockIcon;
export const School = mockIcon;
export const SquareFunction = mockIcon;
export const Lightbulb = mockIcon;
export const Calendar = mockIcon;
export const List = mockIcon;
export const AuthHeader = mockIcon;
