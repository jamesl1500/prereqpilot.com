    ...
    return (
        <DashboardLayout user={user}>
            <div className={styles.container}>
                ...
                <TutorialTooltip
                    tutorialType="academic_plans"
                    title="Make Academic Plans"
                    description="Organize your courses into academic plans with terms and semesters to visualize your path to graduation."
                    position="bottom"
                />
            </div>
        </DashboardLayout>
