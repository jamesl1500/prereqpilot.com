...
export default function EditCoursePage({ course }: EditCoursePageProps) {
  ...
  return (
    <div className={styles.container}>
      {/* Back Button */}
      <button onClick={() => router.push(`/institution/courses/${course.id}`)} className={styles.backButton}>
      ...
      <div className={styles.header}>
        <div className={styles.headerContent}>
          ...
          <div>
            ...
            <p className={styles.subtitle}>{course.code} - {course.title}</p>
          </div>
        </div>
      </div>
      ...
      <div className={styles.formContainer}>
        <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
          ...
          <div className={styles.actions}>
            <button
              type="button"
              onClick={() => router.push(`/institution/courses/${course.id}`)}
